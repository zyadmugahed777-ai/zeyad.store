...
const SUITE = [
  ...
  { file: 'test-admin-list-filters.js', name: 'Admin list filters: does the department narrow the list', timeout: 120000 },
  ...
  { file: 'test-product-canonical.js', name: 'Which page represents a group of near-identical ones', timeout: 60000 },
